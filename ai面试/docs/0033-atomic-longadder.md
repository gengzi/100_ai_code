...
> 序号：0033 ｜ 主题：Atomic 与 LongAdder ｜ 目标：面向 Atomic 与 LongAdder 的面试复习与工程化落地 ｜ 关键词：Atomic 与 LongAdder、并发模型、锁/无锁、吞吐/QPS

## 脑图
```mermaid
mindmap
  root((Atomic 与 LongAdder))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：Atomic 与 LongAdder中最关键的约束是什么？
