...
> 序号：0044 ｜ 主题：Spring MVC vs WebFlux ｜ 目标：面向 Spring MVC vs WebFlux 的面试复习与工程化落地 ｜ 关键词：Spring MVC vs WebFlux、框架分层、拦截器/切面、启动耗时

## 脑图
```mermaid
mindmap
  root((Spring MVC vs WebFlux))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：Spring MVC vs WebFlux中最关键的约束是什么？
