...
> 序号：0042 ｜ 主题：Spring Bean 生命周期 ｜ 目标：面向 Spring Bean 生命周期 的面试复习与工程化落地 ｜ 关键词：Spring Bean 生命周期、框架分层、拦截器/切面、启动耗时

## 脑图
```mermaid
mindmap
  root((Spring Bean 生命周期))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：Spring Bean 生命周期中最关键的约束是什么？
