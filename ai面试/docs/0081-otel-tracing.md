...
> 序号：0081 ｜ 主题：OpenTelemetry 全链路 ｜ 目标：面向 OpenTelemetry 全链路 的面试复习与工程化落地 ｜ 关键词：OpenTelemetry 全链路、观测体系、指标/日志/链路、可用性

## 脑图
```mermaid
mindmap
  root((OpenTelemetry 全链路))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：OpenTelemetry 全链路中最关键的约束是什么？
