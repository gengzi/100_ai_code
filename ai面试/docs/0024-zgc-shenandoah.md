# ZGC/Shenandoah 低延迟策略

> 序号：0024 ｜ 主题：ZGC/Shenandoah 低延迟策略 ｜ 目标：面向 ZGC/Shenandoah 低延迟策略 的面试复习与工程化落地 ｜ 关键词：ZGC Shenandoah 低延迟策略、内存模型/指令重排、参数基线/监控、P99 停顿

## 脑图
```mermaid
mindmap
  root((ZGC/Shenandoah 低延迟策略))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：ZGC/Shenandoah 低延迟策略中最关键的约束是什么？
