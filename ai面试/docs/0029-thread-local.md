...
> 序号：0029 ｜ 主题：ThreadLocal 与线程隔离 ｜ 目标：面向 ThreadLocal 与线程隔离 的面试复习与工程化落地 ｜ 关键词：ThreadLocal 与线程隔离、内存模型/指令重排、参数基线/监控、P99 停顿

## 脑图
```mermaid
mindmap
  root((ThreadLocal 与线程隔离))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：ThreadLocal 与线程隔离中最关键的约束是什么？
