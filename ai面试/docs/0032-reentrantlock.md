# ReentrantLock/Condition 实战

> 序号：0032 ｜ 主题：ReentrantLock/Condition 实战 ｜ 目标：面向 ReentrantLock/Condition 实战 的面试复习与工程化落地 ｜ 关键词：ReentrantLock Condition 实战、并发模型、锁/无锁、吞吐/QPS

## 脑图
```mermaid
mindmap
  root((ReentrantLock/Condition 实战))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：ReentrantLock/Condition 实战中最关键的约束是什么？
