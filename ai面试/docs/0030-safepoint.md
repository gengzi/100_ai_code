...
> 序号：0030 ｜ 主题：Safepoint 与 STW 诊断 ｜ 目标：面向 Safepoint 与 STW 诊断 的面试复习与工程化落地 ｜ 关键词：Safepoint 与 STW 诊断、内存模型/指令重排、参数基线/监控、P99 停顿

## 脑图
```mermaid
mindmap
  root((Safepoint 与 STW 诊断))
    目标
      能力边界
      风险控制
    设计
...
## 问答
1) 问：Safepoint 与 STW 诊断中最关键的约束是什么？
