...
exports.Handle = exports.Vertices = void 0;
...
class Vertices extends tool_1.ToolItem {
    constructor() {
        super(...arguments);
        this.handles = [];
    }
    ...
    renderHandles() {
        ...
        for (let i = 0, l = vertices.length; i < l; i += 1) {
            ...
            const handle = createHandle({
                index: i,
                graph: this.graph,
                guard: (evt) => this.guard(evt), // eslint-disable-line no-loop-func
    ...
    allowAddVertex(e) {
        ...
        const matchModifiers = this.options.modifiers
            ? (0, common_1.isModifierKeyMatch)(e, this.options.modifiers)
            : true;
...
Vertices.defaults = Object.assign(Object.assign({}, tool_1.ToolItem.getDefaults()), { name: 'vertices', snapRadius: 20, addable: true, removable: true, removeRedundancies: true, stopPropagation: true, attrs: {
        r: 6,
        fill: '#333',
        stroke: '#fff',
        cursor: 'move',
        'stroke-width': 2,
    }, createHandle: (options) => new Handle(options), markup: [
        {
            tagName: 'path',
            selector: 'connection',
...
class Handle extends view_1.View {
    ...
    render() {
        this.container = (0, util_1.createViewElement)('circle', true);
