...
export declare class Scheduler extends Disposable {
    ...
    protected createCellView(cell: Cell): CellView<Cell<import("../model").CellProperties>, import("../view/cell/type").CellViewOptions> | EdgeView<import("../model").Edge<import("../model").EdgeProperties>, import("../view/edge/type").EdgeViewOptions> | NodeView<import("../model").Node<import("../model").NodeProperties>, import("../view/node/type").NodeViewOptions>;
