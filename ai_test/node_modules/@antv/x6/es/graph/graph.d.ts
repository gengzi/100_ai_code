...
export declare class Graph extends Basecoat<EventArgs> {
    ...
    static registerView: {
        (entities: {
            [name: string]: import("../view/cell/type").CellViewDefinition;
        }, force?: boolean): void;
        <K extends string | number>(name: K, entity: KeyValue<import("../view/cell/type").CellViewDefinition>[K], force?: boolean): import("../view/cell/type").CellViewDefinition;
        (name: string, entity: import("../view/cell/type").CellViewDefinition, force?: boolean): import("../view/cell/type").CellViewDefinition;
    };
    static registerAttr: {
        (entities: {
    ...
    static unregisterView: {
        <K extends string | number>(name: K): import("../view/cell/type").CellViewDefinition;
        (name: string): import("../view/cell/type").CellViewDefinition;
    };
    ...
    findView(ref: Cell | Element): CellView<Cell<import("../model").CellProperties>, import("../view/cell/type").CellViewOptions>;
    findViews(ref: PointLike | RectangleLike): CellView<Cell<import("../model").CellProperties>, import("../view/cell/type").CellViewOptions>[];
    findViewByCell(cellId: string | number): CellView | null;
    findViewByCell(cell: Cell | null): CellView | null;
    findViewByElem(elem: string | Element | undefined | null): CellView<Cell<import("../model").CellProperties>, import("../view/cell/type").CellViewOptions>;
