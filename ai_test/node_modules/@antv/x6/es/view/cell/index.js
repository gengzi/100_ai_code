...
import { ArrayExt, Dom, disposable, FunctionExt, ObjectExt, Util, } from '../../common';
...
export class CellView extends View {
    ...
    static isCellView(instance) {
        ...
        const view = instance;
        if ((tag == null || tag === CellViewToStringTag) &&
    ...
    static getOptions(options) {
        ...
        const ret = ObjectExt.cloneDeep(CellView.getDefaults());
    ...
    ensureContainer() {
        return createViewElement(this.getContainerTagName(), this.options.isSvgElement);
    }
