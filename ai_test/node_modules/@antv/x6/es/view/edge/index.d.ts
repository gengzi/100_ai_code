...
import { Line, Path, Point, Rectangle, PointLike } from '../../geometry';
import { Edge, EdgeSetOptions, LabelPosition, LabelPositionObject, LabelPositionOptions, TerminalCellData, TerminalData, TerminalType } from '../../model/edge';
...
import { type MarkupJSONMarkup, type MarkupSelectors, type MarkupType } from '../markup';
...
export declare class EdgeView<Entity extends Edge = Edge, Options extends EdgeViewOptions = EdgeViewOptions> extends CellView<Entity, Options> {
    ...
    getTerminalView(type: TerminalType): CellView<import("../..").Cell<import("../..").CellProperties>, import("../cell/type").CellViewOptions>;
