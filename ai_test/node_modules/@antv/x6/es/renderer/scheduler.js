...
import { Disposable, Dom, disposable, FunctionExt, } from '../common';
import { FLAG_INSERT, FLAG_REMOVE } from '../constants';
import { CellView, EdgeView, NodeView } from '../view';
import { JOB_PRIORITY, JobQueue } from './queueJob';
const INSERT_JOB_ID_SUFFIX = '#insert';
export var SchedulerViewState;
...
})(SchedulerViewState || (SchedulerViewState = {}));
export class Scheduler extends Disposable {
    ...
    onCellZIndexChanged({ cell, options, }) {
        ...
        if (viewItem) {
            this.requestViewUpdate(viewItem.view, FLAG_INSERT, options, JOB_PRIORITY.Update, true);
        }
    }
