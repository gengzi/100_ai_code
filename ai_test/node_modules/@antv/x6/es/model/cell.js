...
import { ArrayExt, Basecoat, disposable, FunctionExt, NumberExt, ObjectExt, StringExt, } from '../common';
import { Point, Rectangle } from '../geometry';
import { attrRegistry, } from '../registry';
import { Animation, AnimationManager, KeyframeEffect, } from './animation';
...
export class Cell extends Basecoat {
    ...
    static normalizeTools(raw) {
        ...
        if (Reflect.has(raw, 'local')) {
            const _a = raw, { local } = _a, resetItem = __rest(_a, ["local"]);
            return {
                local,
                items: [resetItem],
            };
