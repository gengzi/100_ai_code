import { isModifierKeyMatch } from '../../common';
...
export class Vertices extends ToolItem {
    constructor() {
        super(...arguments);
        this.handles = [];
    }
...
Vertices.defaults = Object.assign(Object.assign({}, ToolItem.getDefaults()), { name: 'vertices', snapRadius: 20, addable: true, removable: true, removeRedundancies: true, stopPropagation: true, attrs: {
        r: 6,
        fill: '#333',
        stroke: '#fff',
        cursor: 'move',
...
export class Handle extends View {
    get graph() {
