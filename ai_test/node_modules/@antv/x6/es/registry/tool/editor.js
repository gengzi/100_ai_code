...
export class CellEditor extends ToolItem {
    ...
    createElement() {
        ...
        this.editor = createViewElement('div', false);
...
CellEditor.defaults = Object.assign(Object.assign({}, ToolItem.getDefaults()), { tagName: 'div', isSVGElement: false, events: {
...
NodeEditor.defaults = ObjectExt.merge({}, CellEditor.defaults, {
    attrs: {
        fontSize: 14,
...
EdgeEditor.defaults = ObjectExt.merge({}, CellEditor.defaults, {
    attrs: {
        fontSize: 14,
        fontFamily: 'Arial, helvetica, sans-serif',
        color: '#000',
